...
paintings.each do |painting|
  file = URI.open(painting[:url])
  paint = Paint.new(name: painting[:name], artist: painting[:artist], movement: painting[:movement], technique: painting[:technique], year: painting[:year], price: painting[:price], description: painting[:description])
  paint.photo.attach(io: file, filename: "#{painting[:name]}.png", content_type: "image/png")
  paint.save
end
